              ...
              <table role="presentation" border="0" cellpadding="0" cellspacing="0" width="100%">
                <tr>
                  <td style="text-align: center;">
                    <!-- <h1 style="margin: 0;"><a href="#" style="color: #EABD4E; font-size: 24px; font-weight: 700; font-family: 'Lato', sans-serif;"> Swiftearn Prime </a></h1> -->
                  </td>
                </tr>
              </table>
            </td>
          ...
          <tr>
            <td>
              <div style="padding: 0 1.5em; text-align: center;">
                ...
                <h3 style="font-family: 'Lato', sans-serif; font-size: 24px; font-weight: 300;">Use the following one-time password (OTP) to make a Withdrawal on Swiftearn Prime  account. <br>
